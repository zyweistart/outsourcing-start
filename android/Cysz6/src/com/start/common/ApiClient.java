...
import com.start.bean.Result;
import com.start.cysz6.AppContext;
...
public class ApiClient {
	...
	private static GetMethod getHttpGet(String url, String cookie, String userAgent) {
		...
		httpGet.setRequestHeader("Host", Constant.HOST);
	...
	private static PostMethod getHttpPost(String url, String cookie, String userAgent) {
		...
		httpPost.setRequestHeader("Host", Constant.HOST);
	 ...
	 * @throws  
	 */
	public static Result http_post(AppContext appContext, String url, Map<String, Object> params, Map<String,File> files) throws AppException, IOException {
