...
import com.start.common.AppManager;
import com.start.utils.FileUtils;
import com.start.utils.MethodsCompat;
...
public class SettingActivity extends PreferenceActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ViewGroup localViewGroup = (ViewGroup)getLayoutInflater().inflate(R.layout.activity_setting, null);
...
//				account.setTitle(R.string.main_menu_login);
		...
		myinfo.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
			public boolean onPreferenceClick(Preference preference) {
//				UIHelper.showUserInfo(SettingActivity.this);
				return true;
			}
		});
		...
		loadimage.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
			public boolean onPreferenceClick(Preference preference) {
//				UIHelper.changeSettingIsLoadImage(SettingActivity.this,loadimage.isChecked());
...
//				UpdateManager.getUpdateManager().checkAppUpdate(SettingActivity.this, true);
		...
		about.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
			public boolean onPreferenceClick(Preference preference) {
//				UIHelper.showAbout(SettingActivity);
				return true;
			}
		});
