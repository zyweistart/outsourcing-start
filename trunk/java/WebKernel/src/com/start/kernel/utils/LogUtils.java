		...
		public void run() {
			while (true) {
				if(!logqueue.isEmpty()) {
					...
					//日志存放路径
					String logPath = SystemPath.LOG_PATH + getTime(TimeUtils.yyyyMMdd)+ AppConstant.FILESEPARATOR + ConfigParameter.BALANCED_WORKER_INDEX + AppConstant.FILESEPARATOR;
					//日志目录
